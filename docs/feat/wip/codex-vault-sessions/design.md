...
**Status:** Draft, revised 2026-09-13 after four independent design reviews and a second round of two reviews plus a code-level self-review (corroboration and per-finding evidence in [design-triage.md](./design-triage.md)); awaiting re-review with `/kk:review-design`
