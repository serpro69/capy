...
- `docs/feat/wip/sessionflow-rag/design-v2.md` — this feature's design document
- `docs/feat/wip/sessionflow-rag/design.md` — v1 design (context for what already exists)
