...
- [x] `/kk:document` — README + architecture.md command tables updated with `reindex`; `docs/feat/wip/vault/v2/tasks.md` Task 1 → done-on-branch, Task 5.2 → runner-already-built
